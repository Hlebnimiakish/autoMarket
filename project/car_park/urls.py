...
auto_park_router.register(r'dealer_auto_park',
                          DealerAutoParkFrontView,
                          basename='dealer-park')
auto_park_router.register(r'seller_auto_park',
                          SellerAutoParkFrontView,
                          basename='seller-park')
auto_park_router.register(r'my_seller_auto_park',
                          SellerOwnAutoParkView,
                          basename='my-seller-park')
auto_park_router.register(r'my_dealer_auto_park',
