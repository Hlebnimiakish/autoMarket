...
class BaseSalesHistoryModel(BaseModel):
    ...
    buyer: ForeignKey = ForeignKey('user_app.AutoDealerModel', on_delete=models.CASCADE)
...
class DealerSalesHistoryModel(BaseSalesHistoryModel):
    buyer: ForeignKey = ForeignKey('user_app.CarBuyerModel', on_delete=models.CASCADE)
...
class CarBuyerHistoryModel(BaseModel):
    bought_car_model: ForeignKey = ForeignKey('car_market_app.MarketAvailableCarModel',
                                              on_delete=models.CASCADE)
    auto_dealer: ForeignKey = ForeignKey('user_app.AutoDealerModel',
                                         on_delete=models.CASCADE)
